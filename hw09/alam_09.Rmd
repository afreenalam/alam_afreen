...
The graph shows the distribution of basal_cort for each site. It also shows the mean (green) for each site with its standard error (above and below the mean in red)
